...
@section('title', 'Приход — '.$ingredient->name)
...
<div class="card" style="max-width:520px;margin:0 auto;">
  <div class="card-header" style="background:#e8724a;color:#fff;">
    <h3 class="card-title">
      ...
      Приход: <strong>{{ $ingredient->name }}</strong>
    </h3>
  </div>
  <div class="card-body">
    ...
    <form action="{{ route('backend.admin.ingredients.arrival', $ingredient->id) }}" method="POST">
      ...
      <div class="form-group">
        <label>Добавить количество <span class="text-danger">*</span>
      ...
      <div class="d-flex justify-content-between">
        ...
        <button type="submit" class="btn btn-success">
          <i class="fas fa-plus-circle"></i> Добавить на склад
        </button>
      </div>
    </form>
  </div>
