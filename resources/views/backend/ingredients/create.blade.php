    ...
    <form action="{{ route('backend.admin.ingredients.store') }}" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
               value="{{ old('name') }}" placeholder="e.g. Coffee Beans" required>
      ...
      <div class="form-group">
        ...
        <select name="unit" class="form-control @error('unit') is-invalid @enderror" required>
          ...
          <option value="g"   {{ old('unit') === 'g'   ? 'selected' : '' }}>g (grams)</option>
          <option value="ml"  {{ old('unit') === 'ml'  ? 'selected' : '' }}>ml (millilitres)</option>
      ...
      <div class="form-group">
        ...
        <small class="text-muted">Current amount on hand (in the selected unit).</small>
